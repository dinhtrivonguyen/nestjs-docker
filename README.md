...
I'm not going to go too much in depth on NestJS or Docker since the main focus of this repo is to run a NestJS app environment with Docker and that's about it.
